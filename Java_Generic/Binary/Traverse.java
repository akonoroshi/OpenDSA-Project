...
public class Traverse {
	...
	public static void main(String args[]) throws IOException {
		...
		BSTNode<KVPair<Integer, String>> rt2 = new BSTNode<KVPair<Integer, String>>(
				new KVPair<Integer, String>(new Integer(5), "John"));

		if (!CheckBST.checkBST(rt2, new KVPair<Integer, String>(new Integer(-1), ""),
